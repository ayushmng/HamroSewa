...
public class RadioActivitydeCCU extends Fragment {
...
//    String fetchurl = "http://10.0.2.2/MyApplication/select.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_ccuradio, null);
            ...
            public void callback(String url, JSONArray array, AjaxStatus status) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    try {
                        ...
                        info.total = object.getString("Total2");
                        info.vaccant = object.getString("Vaccant2");
                        list.add(info);
